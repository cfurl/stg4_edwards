...
####FUNCTION####
plot_bin_map_interactive<-function(
  ...
  plot<-ggplot()+
    ...
    ggiraph::geom_sf_interactive(data=map_rain, mapping=aes(fill=sum_rain, data_id = grib_id, tooltip = paste0("<b>Rainfall</b>: ",sum_rain,"mm")),color=pal_bin_outline, alpha=bin_alpha)+
...
# 
# plot<-plot_bin_map_interactive(title = 'Edwards Aquifer Recharge Zone',
...
#        height_svg = 6.5,
#        options = list(
#          opts_tooltip(css="font-family:Open Sans;background:black;color:white;padding:2px 4px;border-radius:2px"),
